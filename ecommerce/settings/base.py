...
""",
    ...
    "TAGS": [
        {"name": "Auth: JWT", "description": "Login and token refresh"},
        {"name": "Auth: Roles", "description": "Role definitions"},
        {"name": "Auth: UserRoles", "description": "User–role assignments"},
        {"name": "Auth: Users", "description": "User management"},
        {"name": "Cart", "description": "Shopping cart"},
        {"name": "Cart Items", "description": "Items in the shopping cart"},
        {"name": "Core: Addresses", "description": "Billing & shipping addresses"},
        {"name": "Core: Audit Logs", "description": "Read-only event trail"},
        {"name": "Notifications", "description": "User notifications & actions"},
        {"name": "Order Items", "description": "Line items on orders"},
        {"name": "Orders", "description": "Order lifecycle"},
        {"name": "Payments", "description": "Payment initiation & status"},
        {"name": "Products", "description": "Product catalogue"},
        {"name": "Products: Categories", "description": "Category management"},
        {"name": "Products: Media", "description": "Product media assets"},
        {"name": "Products: Reviews", "description": "Product reviews"},
        {"name": "Products: Variants", "description": "Product variants"},
        {"name": "Refunds", "description": "Refund creation & retrieval"},
        {"name": "Vendors", "description": "Vendors & suppliers"},
    ],
